...
GalleryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: GalleryComponent, selectors: [["gallery"]], decls: 7, vars: 0, consts: [[1, "container"], [1, "row"], [1, "col-sm-4", "animado", "m-auto"], ["src", "../../../assets/ari.jpg", 1, "img-fluid1"]], template: function GalleryComponent_Template(rf, ctx) { if (rf & 1) {
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 7, vars: 0, consts: [[1, "container-fluid"], [1, "footer", "text-center"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
